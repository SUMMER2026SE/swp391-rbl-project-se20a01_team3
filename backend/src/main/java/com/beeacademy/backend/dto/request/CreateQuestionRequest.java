...
public record CreateQuestionRequest(
        ...
        @NotNull
        @Pattern(regexp = "multiple_choice|true_false|essay", message = "Loại phải là: multiple_choice, true_false, essay")
        String type,

        @Size(max = 4, message = "Câu hỏi trắc nghiệm tối đa 4 đáp án")
        @Valid
